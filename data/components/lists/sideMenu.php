<div class="sidemenu">
    ...
    <a href="/lists/expense/expense.php" ><div <?php echo strpos($current_page, '/lists/expense/expense.php') !== false ? 'class="sidemenuItemSelected"' : ''; ?>>Expenses</div></a>
    ...
    <a href="/lists/income/income.php"><div <?php echo strpos($current_page, '/lists/income/income.php') !== false ? 'class="sidemenuItemSelected"' : ''; ?>>Income</div></a>
